 ...
 *
 * <p>Persists user credentials, roles, and timestamps. Maintains a one-to-many relationship with
 * {@link TaskEntity} and calculates total assigned task count via a Hibernate formula subquery.
 *
 * @since 1.0.0
 */
@Getter
