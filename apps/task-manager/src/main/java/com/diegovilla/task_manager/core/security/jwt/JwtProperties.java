 ...
 *
 * <p>Binds properties mapped under the {@code security.jwt} prefix in application configuration
 * files.
 *
...
public record JwtProperties(String secret, long expSecret, String refresh, long expRefresh) {}
