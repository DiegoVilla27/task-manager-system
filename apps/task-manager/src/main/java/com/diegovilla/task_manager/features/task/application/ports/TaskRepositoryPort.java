 ...
 *
 * <p>Defines abstraction contracts for persistence adapters, decoupling application logic from
 * concrete database technologies.
 *
 * @since 1.0.0
 */
public interface TaskRepositoryPort {
    ...
    /**
     * Checks whether a task with the given title already exists, performing a case-insensitive
     * comparison.
     *
