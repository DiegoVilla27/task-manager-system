 ...
 *
 * <p>Documents the {@code GET /users/me} operation which resolves the authenticated user's profile
 * details from the JWT bearer token present in the security context.
 *
 * @since 1.0.0
 */
...
@Operation(
        ...
        description =
                "Retrieves the identity and profile information of the currently authenticated user based on the security context.")
@ApiResponse(
        responseCode = "200",
