...
@Component({
  ...
  template: `
    <button (click)="openMenu()" cdkOverlayOrigin #origin="cdkOverlayOrigin">Options</button>
...
<cdk-virtual-scroll-viewport itemSize="50" class="example-viewport">
  ...
  <div *cdkVirtualFor="let item of hugeArray" class="example-item">{{item.name}}</div>
</cdk-virtual-scroll-viewport>
```

_(Note: Requires a fixed height on the viewport container)._
