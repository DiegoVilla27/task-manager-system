...
_(If a developer breaks these rules, their IDE will throw a red error and the CI pipeline will fail)._
...
_Architecture Note: Remotes can be deployed independently without recompiling the Host. This allows the Billing team to deploy 10 times a day without affecting the HR team._
