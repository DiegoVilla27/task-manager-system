...
public class TaskServiceTest {
  ...
  void shouldGetUserById() {
    ...
    when(taskRepositoryPort.getByIdWithUser(task.getId())).thenReturn(Optional.of(taskWithUser));
  ...
  void shouldUpdateTask() {
    ...
    when(taskRepositoryPort.existsByTitleIgnoreCase(StringUtils.normalize(command.title()))).thenReturn(false);
  ...
  void shouldRejectUpdateTaskIfTitleExists() {
    ...
    when(taskRepositoryPort.getByIdWithUser(taskId)).thenReturn(Optional.of(taskWithUser));
    when(taskRepositoryPort.existsByTitleIgnoreCase(StringUtils.normalize(command.title()))).thenReturn(true);
