package com.diegovilla.task_manager.task.domain.errors;

import com.diegovilla.task_manager.core.errors.exceptions.ApiException;
import org.springframework.http.HttpStatus;

/**
 * Exception thrown when attempting to create or rename a task using
 * a title that already belongs to another task.
 *
