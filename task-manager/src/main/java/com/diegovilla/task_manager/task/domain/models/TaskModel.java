package com.diegovilla.task_manager.task.domain.models;
...
/**
 * Domain model representing a task and its lifecycle.
 *
 * <p>
 * This is the core aggregate of the task bounded context. It
 * encapsulates all business rules related to task creation,
 * information updates and status transitions.
 * </p>
 *
 * <p>
 * Instances are created through the factory methods
 * {@link #create(String, String, UUID)} (for new tasks) and
 * {@link #reconstruct(UUID, String, String, TaskStatus, Instant, Instant)}
