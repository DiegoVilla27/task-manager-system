 ...
 *
 * <p>Provides reusable validation methods for String values used by
 * domain models during creation and partial update operations.</p>
 *
 * <p>The utility is intentionally independent from DTOs, controllers,
 * persistence, and framework-specific validation mechanisms.</p>
 */
public final class ValidateDataUtils {
   ...
   *
   * <p>The value must not be {@code null} or blank.</p>
   *
   ...
   *
   * <p>The value must not be {@code null} or blank and must have
   * a length between {@code minLength} and {@code maxLength}.</p>
   *
   * @param value value to validate.
   ...
   *
   * <p>The value must not be {@code null} or blank and must match
   ...
   *
   * <p>The value must not be {@code null} or blank, must satisfy
   * the specified length range, and must match the provided pattern.</p>
   *
   * @param value value to validate.
   * @param minLength minimum allowed length.
   * @param maxLength maximum allowed length.
   ...
   *
   * <p>A {@code null} value preserves the current value. When a
   * value is provided, it must not be blank.</p>
   *
   * @param value new value supplied by the caller.
   * @param currentValue current value.
   * @param fieldName field name used in error messages.
   * @return the validated new value or the current value when
   ...
   *
   * <p>A {@code null} value preserves the current value. When a
   * value is provided, it must satisfy the specified length range.</p>
   *
   * @param value new value supplied by the caller.
   * @param currentValue current value.
   * @param minLength minimum allowed length.
   ...
   *
   * <p>A {@code null} value preserves the current value. When a
   * value is provided, it must satisfy the specified pattern.</p>
   *
   * @param value new value supplied by the caller.
   * @param currentValue current value.
   * @param pattern regular expression used for validation.
   ...
   *
   * <p>A {@code null} value preserves the current value. When a
   * value is provided, it must satisfy both the specified length
   * range and regular expression.</p>
   *
   * @param value new value supplied by the caller.
   * @param currentValue current value.
   * @param minLength minimum allowed length.
  ...
  private static void validatePattern(
    ...
    if (pattern == null) {
      throw new IllegalArgumentException(
        "Validation pattern cannot be null"
      );
    }
