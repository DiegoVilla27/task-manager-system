 ...
 *
 * <p>Defines abstraction contracts for database access, decoupling domain logic from concrete ORM
...
public interface UserRepositoryPort {
    ...
    /**
     * Retrieves a paginated list of users with associated task counts matching optional filter
     * criteria.
     *
