...
@Documented
@Operation(summary = "Retrieve a task", description = "Returns the information of a specific task identified by its UUID.")
@Parameter(name = "id", description = "Unique task identifier.", required = true)
@ApiResponse(responseCode = "200", description = "Task retrieved successfully.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = TaskResponseDTO.class)))
@NotFoundApiResponse
