 ...
 * authorization role, and audit timestamps.
 *
 * @since 1.0.0
 */
@Getter
public class UserModel {
     ...
     */
    public static UserModel create(String name, String lastname, String email, String password) {
    ...
    /**
     * Reconstructs an existing {@link UserModel} from persistence without re-validating domain
     * constraints.
     *
     ...
     */
    public void updateInformation(String name, String lastname, String email) {
        this.name = ValidateDataUtils.updateIfPresent(name, this.name, 3, 100, "Name");
        this.lastname =
                ValidateDataUtils.updateIfPresent(lastname, this.lastname, 3, 100, "Lastname");
