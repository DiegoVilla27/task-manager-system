...
@Schema(
        description =
                "Composite task response containing task details and embedded owner user information")
public record TaskWithUserResponseDTO(
        @Schema(
                        description = "Unique identifier of the task",
                        example = "987e6543-e21b-12d3-a456-426655440000")
                UUID id,
        @Schema(description = "Title of the task", example = "Implement OAuth2 login") String title,
        @Schema(
