...
@Documented
@Operation(summary = "Start a task", description = "Starts execution of a task by setting its status to IN_PROGRESS.")
@Parameter(name = "id", description = "Unique task identifier.", required = true)
@ApiResponse(responseCode = "200", description = "Task started successfully.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = TaskModel.class)))
