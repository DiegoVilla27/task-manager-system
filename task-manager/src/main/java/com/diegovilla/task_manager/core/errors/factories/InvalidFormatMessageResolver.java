...
/**
 * Utility class responsible for resolving user-friendly validation messages according to the
 * expected Java type.
 *
 * <p>It is primarily used by Spring exception handlers when a request value cannot be converted to
...
public final class InvalidFormatMessageResolver {
    ...
    private static final Map<Class<?>, String> MESSAGES =
            Map.ofEntries(
     ...
     *
     * <p>If the target type is an {@code Enum}, the returned message includes all allowed values.
     *
    ...
    public static String resolve(Class<?> targetType) {
        ...
        return MESSAGES.getOrDefault(
                targetType, "The provided value is not compatible with the expected type.");
    }
}
