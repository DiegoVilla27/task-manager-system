 ...
 *
 * <p>Used as part of {@link ErrorResponseDTO} to provide detailed information about validation or
 * binding errors returned by the API.
 *
...
public record FieldErrorDTO(
        ...
        @Schema(
                        description =
                                "User-friendly validation error message explaining the failure constraint",
