 ...
 *
 * <p>Mapped to HTTP {@code 422 Unprocessable Content} to indicate that the
 * server understands the request but cannot process it due to semantic
 * errors in the domain logic.</p>
 *
 * @since 1.0.0
 */
