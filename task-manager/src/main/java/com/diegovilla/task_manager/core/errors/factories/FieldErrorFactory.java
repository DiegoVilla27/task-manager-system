 ...
 *
 * <p>Centralizing the creation of field-level validation errors provides a single extension point
 * for future transformations or formatting without impacting the exception handlers.
 *
 * @since 1.0.0
 */
@Component
