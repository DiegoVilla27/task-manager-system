 ...
 *
 * <p>All exception handlers use this factory to guarantee that every
 * error returned by the API follows the same response structure,
 * regardless of the exception origin.</p>
 *
 * @since 1.0.0
 */
@Component
public class ErrorResponseFactory {
   ...
   * @param errors  collection of field-level validation errors.
