 ...
 *
 * <p>Inspects the declared fields of the annotated object using a
 * {@link BeanWrapper} and returns {@code true} when at least one of
 * the configured fields holds a non-{@code null}, non-blank value.</p>
 *
 * @since 1.0.0
 */
public class AtLeastOneFieldValidator
   ...
   *
   * <p>{@code null} objects are considered valid to allow composition
   * with other constraints such as {@code @NotNull}.</p>
   *
   * @param value   the object to validate.
   * @param context contextual data and operation when applying the constraint.
   * @return {@code true} if at least one field contains a value;
   *         {@code false} otherwise.
   * @throws IllegalArgumentException if a declared field does not exist
