 ...
 *
 * <p>Each module implements this contract to register the constraints it handles.</p>
 */
public interface DatabaseExceptionResolver {
   ...
   * @return corresponding domain exception, or {@code null} if this resolver does not handle the constraint.
   */
