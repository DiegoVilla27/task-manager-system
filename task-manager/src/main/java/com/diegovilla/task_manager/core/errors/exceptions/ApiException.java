...
/**
 * Base abstract class for all application-specific domain and business exceptions.
 *
 * <p>Encapsulates an HTTP status code and a descriptive error message. Subclasses are automatically
 * captured by {@link ApiExceptionHandler}, which converts them into a standardized {@link
 * ErrorResponseDTO}.
 *
 * @author Diego Villa
 * @since 1.0.0
